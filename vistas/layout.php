...
<body>
    ...
    <aside id="sidebar" class="sidebar">
        ...
        <ul class="sidebar-nav" id="sidebar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" data-bs-target="#escenario-nav" data-bs-toggle="collapse" href="#">
                    <i class="bi bi-shop-window"></i><span>Escenario</span><i class="bi bi-chevron-down ms-auto"></i>
                </a>
                <ul id="escenario-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
                    <li>
                        <a href="alquiler.php">
